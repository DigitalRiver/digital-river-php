...
class Errors implements ModelInterface, ArrayAccess
{
    ...
    const TYPE_REQUEST_TIMEOUT = 'request_timeout';
    ...
    const TYPE_METHOD_NOT_ALLOWED = 'method_not_allowed';
    const TYPE_NOT_ACCEPTABLE = 'not_acceptable';
    const TYPE_FORBIDDEN = 'forbidden';
    const TYPE_BAD_GATEWAY = 'bad_gateway';
