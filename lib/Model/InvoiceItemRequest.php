 ...
 * @link     https://openapi-generator.tech
 */
class InvoiceItemRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets price
     *
     * @param double|null $price The price of an item. You are required to provide this parameter or <code>aggregatePrice</code>.
     *
     * @return $this
     */
     ...
     *
     * @param double|null $aggregate_price The total price of multiple items. You are required to provide this parameter or <code>price</code>.
     *
     * @return $this
     */
