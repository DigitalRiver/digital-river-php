...
class CountrySpecificationsApi
{
     ...
     * @param  string $selling_entity Represents the [selling entity](https://docs.digitalriver.com/digital-river-api/checkouts-and-orders/checkouts/selling-entities) assigned to the order. (required)
     *
